...
*/
//EXAMPLe-4 in the above exaample i am getting the garbage value due to <CR><LR> so in this i have resolved this issue. and now it is displaying the correct value in the p10 display
#include <DMD3.h>
#include <SoftwareSerial.h>
#include <SPI.h>
#include <TimerOne.h>
